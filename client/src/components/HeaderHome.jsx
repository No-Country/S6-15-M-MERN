...
export const HeaderHome = () => {
    ...
    <div className='divHeader py-8'>
        <div className='w-5/12 textDiv'>
          ...
          <Link to="/servicios"><button className='text-textWhite inline-flex items-center justify-center whitespace-nowrap rounded-md border-transparent bg-buttons-buttonGreen px-4 py-2 text-base font-medium shadow-sm hover:bg-indigo-700'>
