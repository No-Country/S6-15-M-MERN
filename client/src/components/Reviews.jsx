  ...
  return (
    <div>
      <div>
        <div
          ref={carousel}
          className=' cards-carousel mt-[19rem] p-4 flex flex-nowrap items-center overflow-x-auto relative  scroll-smooth scrollbar-hide  '
        >
          <div className='card-1 m-2 rounded-[100px] border-2 w-[295px] h-[435px] transition duration-300 ease-in-out'>
