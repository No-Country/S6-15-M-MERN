  ...
  return (
    <div>
      ...
      <img
        ...
        src={Facebook}
      />
      <p className="relative font-['Inter'] not-italic font-normal text-[13px] leading-[120%] top-[-204px] left-[488px] ml-[100px] flex items-center text-[#083A50]">
        Mariana Sepúlveda
      </p>
      ...
      <img
        ...
        src={Telefono}
      />
      <p className="relative font-['Inter'] not-italic font-medium text-[16px] leading-[120%] top-[-270px] left-[40px] flex items-center text-[#083A50]">
        + 59 1 1001 8830
      </p>
      <p className="relative font-['Inter'] not-italic font-medium text-[16px] leading-[120%] top-[-250px] left-[40px] flex items-center text-[#083A50]">
        + 59 1 1001 8830
      </p>
