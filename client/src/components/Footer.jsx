...
export default function Footer(){
    return(
     <div>
        <footer className="flex flex-col items-center p-[64px 24px 8px] w-[100%] h-screen rounded-none flex-none order-4 grow-0">
        <div className="flex justify-end">
            <div className="columns-3 flex flex-row items-start absolute p-4 gap-8  w-[100%] h-screen left-[721px] top-[3273px] rounded-none">
                <ul>
          ...
          <div className="flex flex-row items-center p-8 gap-16 absolute w-[100%] left-[1.5px] top-[3200px]">
           <img src={Contrata}/>
          </div>

          <div className="columns-3">
          <ul className="flex flex-row items-center p-10 gap-16 absolute w-[100%] h-[51px] left-[1.5px] top-[3273px]">
          ...
          <div className="flex flex-row items-center p-10 gap-16 absolute w-[100%] bottom-0px left-[540px] top-[3380px] text-gray-600">  
