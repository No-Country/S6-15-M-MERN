        ...
        >
          <Form>
            <div className="flex flex-wrap">
              ...
              <div className="flex  flex-row w-full">
              <div className="p-3 w-1/2">
                  <label className="  font-bold block text-[#313D69] mt-5 mr-56" >Tipo de usuario</label>
                  <Field
                    name="tipo"
                    id="tipo"
                    type="text"
                    ...
                    className=" px-3 py-2 focus: outline-none rounded-xl text-left w-full"
                  />
                  <ErrorMessage name="tipo" component="p" className="font-bold  text-red-500" />
                </div>
              ...
              />
              <ErrorMessage name="consulta" component="p" className="font-bold  text-red-500"/>
